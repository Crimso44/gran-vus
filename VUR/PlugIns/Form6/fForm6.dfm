object Form6List: TForm6List
  ...
  Caption = 
    ...
    #1086#1073#1103#1079#1072#1085#1085#1086#1089#1090#1080' (2014'#1075'.)'
  ClientHeight = 468
  ClientWidth = 790
  Color = clBtnFace
  ...
  object dxDBGrid: TdxDBGrid
    ...
    object COL_1Column: TdxDBGridColumn
      ...
      Caption = #1042#1089#1077#1075#1086#10#1088#1072#1073#1086#1090#1072#1102#1097#1080#1093#10#10#10#10#10#10#10'(1)'
      DisableCustomizing = True
      DisableDragging = True
      HeaderAlignment = taCenter
      Sizing = False
    ...
    object COL_2Column: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = #1042#1089#1077#1075#1086#10#10#10#10#10#10#10#10'(2)'
      DisableCustomizing = True
      DisableDragging = True
      HeaderAlignment = taCenter
      Sizing = False
    ...
    object COL_3Column: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = #1042' '#1090'.'#1095'.'#10#1086#1092#1080#1094#1077#1088#1086#1074#10#10#10#10#10#10#10'(3)'
      DisableCustomizing = True
      DisableDragging = True
      HeaderAlignment = taCenter
      Sizing = False
    ...
    object COL_5Column: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 
        #1063#1080#1089#1083#1077#1085#1085#1086#1089#1090#1100#10#1087#1088#1072#1087#1086#1088#1097#1080#1082#1086#1074','#10#1084#1080#1095#1084#1072#1085#1086#1074','#10#1089#1077#1088#1078#1072#1085#1090#1086#1074', '#1089#1090#1072#1088#1096#1080#1085','#10#1089#1086#1083#1076#1072#1090' '#1080' ' +
        #1084#1072#1090#1088#1086#1089#1086#1074#10#1079#1072#1087#1072#1089#1072', '#1086#1075#1088#1072#1085#1080#1095#1077#1085#1085#1086#10#1075#1086#1076#1085#1099#1093' '#1082' '#1074#1086#1077#1085#1085#1086#1081#10#1089#1083#1091#1078#1073#1077#10'(5)'
      DisableCustomizing = True
      DisableDragging = True
      HeaderAlignment = taCenter
      Sizing = False
    ...
    object COL_12Column: TdxDBGridColumn
      Caption = #1064#1090#1072#1090#1085#1072#1103#10#1095#1080#1089#1083#1077#1085#1085#1086#1089#1090#1100#10#1085#1072' '#1056#1043#10#10#10#10#10#10'(12)'
      DisableCustomizing = True
      DisableDragging = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
