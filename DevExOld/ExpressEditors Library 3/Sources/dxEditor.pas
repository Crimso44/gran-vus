...
uses
  System.SysUtils, Messages, Windows, Classes, Vcl.Graphics, Vcl.Menus, Vcl.Controls, Vcl.Forms,
  Vcl.StdCtrls, Vcl.Mask, dxCntner{$IFDEF DELPHI4}, Vcl.ActnList, Vcl.StdActns{$ENDIF},
...
uses
  Vcl.Consts, Vcl.Clipbrd, dxEdStr;
...
begin
  Result := IChar;
  case IChar of
    mMskTimeSeparator: Result := FormatSettings.TimeSeparator;
    mMskDateSeparator: Result := FormatSettings.DateSeparator;
  end;
end;
