...
//get data
  ...
  edSName.Text := F.edSName.Text;
  edRegNum.Text := F.edRegNum.Text;
  if F.dtRegDate.Text=EmptyStr
    then dtRegDate.Text := EmptyStr
    else dtRegDate.Date := F.dtRegDate.Date;
  ...
  edFactAddr.Text := F.edFactAddr.Text;
...
//set data
  ...
  F.edSName.Text := edSName.Text;
  F.edRegNum.Text := edRegNum.Text;
  if dtRegDate.Text=EmptyStr
    then F.dtRegDate.Text := EmptyStr
    else F.dtRegDate.Date := dtRegDate.Date;
  ...
  F.edFactAddr.Text := edFactAddr.Text;
