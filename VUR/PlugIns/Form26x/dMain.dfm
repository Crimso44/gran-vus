object dmMain: TdmMain
  ...
  object qrStudyHistory: TADOQuery
    ...
    SQL.Strings = (
      ...
      'IN_ORD_NUMB,'
      'IN_ORD_DATE,'
      'n.NAPR_KOD, n.NAPR_NAME,'
      'nn.NAPR_KOD as NNAPR_KOD, nn.NAPR_NAME as NNAPR_NAME,'
      'n.time_y, n.time_m, n.time_d'
      'from ((((Appointment sh'
      'left join KPOST p on p.POST_ID = sh.POST_ID)'
      'left join KDEPART d on d.DEP_ID = sh.DEP_ID)'
      'left join KNAPR n on n.NAPR_ID = sh.NAPR_ID)'
      'left join KNAPR nn on nn.NAPR_KOD = left(n.NAPR_KOD, 2)+"0000")'
      'WHERE PERS_ID = :PERS_ID'
      '  and cprof2015_id = 500'
      'ORDER BY IN_DATE')
    Left = 207
    Top = 66
  end
