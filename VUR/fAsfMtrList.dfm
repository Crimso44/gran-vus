object fmAsfMtrList: TfmAsfMtrList
  Left = 227
  Top = 229
  HelpContext = 15
  Caption = #1055#1086#1090#1088#1077#1073#1085#1086#1089#1090#1100' ('#1079#1072#1103#1074#1082#1072') '#1074' '#1052#1058#1056' '#1076#1083#1103' '#1086#1089#1085#1072#1097#1077#1085#1080#1103' '#1040#1057#1060'/'#1087#1086#1076#1088#1072#1079#1076#1077#1083#1077#1085#1080#1081' '#1040#1057#1060
  ClientHeight = 424
  ClientWidth = 732
  Color = clBtnFace
  ...
  object TabControl: TTabControl
    ...
    object Grid: TdxDBGrid
      ...
      object GridMtrType: TdxDBGridColumn
      ...
      object GridMtrTypeSub: TdxDBGridColumn
        Caption = #1055#1086#1076#1074#1080#1076' '#1052#1058#1056
        Color = clBtnFace
        DisableDragging = True
        DisableEditor = True
        Sorted = csUp
      ...
      object GridPost_Total: TdxDBGridColumn
        Caption = #1042' '#1085#1072#1083#1080#1095#1080#1080' '#1074' '#1086#1088#1075#1072#1085#1080#1079#1072#1094#1080#1080
        Color = clBtnFace
        DisableDragging = True
        DisableEditor = True
        Width = 100
        BandIndex = 0
        RowIndex = 0
        FieldName = 'AsfMtr_Total'
        SummaryFooterType = cstSum
        SummaryFooterFormat = '0'
      end
      object GridDeficit: TdxDBGridColumn
        Caption = #1054#1073#1097#1072#1103' '#1087#1086#1090#1088#1077#1073#1085#1086#1089#1090#1100
        Color = clBtnFace
        DisableDragging = True
        DisableEditor = True
        Width = 100
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarButton7: TdxBarButton
      Action = actRevertRow
      Caption = #1076#1083#1103' '#1090#1077#1082#1091#1097#1077#1075#1086' '#1052#1058#1056
      Category = 0
    end
    ...
    object dxBarButton11: TdxBarButton
      ...
      Caption = #1044#1083#1103' '#1090#1077#1082#1091#1097#1077#1075#1086' '#1052#1058#1056
      Category = 0
    end
  ...
  object qrData: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM AsfMtrListAll order by AsfMtr_Id, ASP_ID')
    Left = 28
    Top = 72
  end
