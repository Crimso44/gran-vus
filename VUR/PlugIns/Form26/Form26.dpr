...
begin
  ...
  if not dmMain.OpenData(nPersID) then begin
    ...
    MessageBox(Application.Handle,
      'Ошибка при обращении к базе данных!',
      'Печать справки об обучении учащегося колледжа или студента',MB_OK or MB_ICONERROR);
    Result := -1;
  end
  else
  begin
    ...
    begin
      ...
      MessageBox(Application.Handle,
        ...
        'Печать справки об обучении учащегося колледжа или студента',MB_OK or MB_ICONWARNING);
    end;
  end;
  end;
  finally
