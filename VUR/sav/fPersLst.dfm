object fmPersonList: TfmPersonList
  ...
  object dbgData: TdxDBGrid
    ...
    OptionsBehavior = [edgoAnsiSort, edgoAutoSearch, edgoAutoSort, edgoDragScroll, edgoEnterShowEditor, edgoImmediateEditor, edgoMultiSort, edgoStoreToIniFile, edgoTabThrough, edgoVertThrough]
    ...
    object dbgDataColumn188: TdxDBGridMaskColumn
      Visible = False
      BandIndex = 0
      RowIndex = 0
      FieldName = 'TooOld'
  ...
  object DataSQL: TMemo
    ...
    Lines.Strings = (
      ...
      ''
        ...
        ' left outer join Assign on Assign.Pers_ID=[Person].PERS_ID) --As' +
        'signText !!!'
