...
uses
  Windows, dxCore7, dxUxTheme, dxThemeManager, dxOffice11,
{$IFDEF DELPHI6}
  Types,
{$ENDIF}
...
type
  ...
  ['{76444D80-2C4B-48B9-C6CD-89306109935F}']
...
class procedure TcxCustomLookAndFeelPainter.LayoutViewDrawRecordExpandButton(
