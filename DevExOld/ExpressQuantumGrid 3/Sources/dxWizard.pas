...
uses
  ...
  Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.Buttons, dxDBGrid, Vcl.Menus, Vcl.ComCtrls, dxTL,
  dxTLClms, dxCntner, dxExEdtr, dxDBCtrl{$IFDEF DELPHI4}, Vcl.ImgList{$ENDIF}
  {$IFNDEF DELPHI6}, DsgnIntf, System.ImageList, Vcl.ImgList{$ELSE},  DesignIntf, DesignEditors{$ENDIF};
