object dmMain: TdmMain
  ...
  object qrPerson: TADOQuery
    ...
    SQL.Strings = (
        ...
        ',Appointment.*,KP.*,IIF(KD.DEP_FULL_NAME is null, KD.DEP_NAME, K' +
        'D.DEP_FULL_NAME) as DEP_FULL_NAME'
      ','
      ...
      'left outer join Appointment on (P.AppLastAll=Appointment.Id))'
        ...
        'left outer join [KDEPART] KD on (Appointment.DEP_ID=[KD].DEP_ID)' +
        ')'
      ''
    ...
    object qrPersonEduc1: TWideStringField
      FieldKind = fkCalculated
      FieldName = 'Educ1'
      ReadOnly = True
      Size = 255
    ...
    object qrPersonEduc2: TWideStringField
      FieldKind = fkCalculated
      FieldName = 'Educ2'
      ReadOnly = True
      Size = 255
    ...
    object qrPersonEduc3: TWideStringField
      FieldKind = fkCalculated
      FieldName = 'Educ3'
      ReadOnly = True
      Size = 255
    ...
    object qrPersonWRNG_Date: TDateTimeField
      FieldName = 'WRNG_Date'
    end
    object qrPersonKOKPDTR: TIntegerField
      FieldName = 'KOKPDTR'
    end
    object qrPersonCPROF2015_ID: TIntegerField
      FieldName = 'CPROF2015_ID'
    end
  ...
  object qrPersonSQL: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  iif((Kuz.UZ_NAME is null)   ,'#39#39','#39', '#39'+Kuz.UZ_NAME)'
        ...
        ' +iif((Educ.END_DATE is null) ,'#39#39','#39', '#39'+convert(varchar, Educ.END' +
        '_DATE,104))'
      ' +iif((Educ.KVAL is null)     ,'#39#39','#39', '#39'+Educ.KVAL)'
      ' +iif((Educ.NAPR is null)     ,'#39#39','#39', '#39'+Educ.NAPR) as Educ1,'
      ''
      '  iif((Kuz2.UZ_NAME is null)  ,'#39#39','#39', '#39'+Kuz2.UZ_NAME)'
      
        ' +iif((Educ2.END_DATE is null),'#39#39','#39', '#39'+convert(varchar, Educ2.EN' +
        'D_DATE,104))'
      ' +iif((Educ2.KVAL is null)    ,'#39#39','#39', '#39'+Educ2.KVAL)'
      ' +iif((Educ2.NAPR is null)    ,'#39#39','#39', '#39'+Educ2.NAPR) as Educ2,'
      ''
      '  iif((Kuz3.UZ_NAME is null)  ,'#39#39','#39', '#39'+Kuz3.UZ_NAME)'
      
        ' +iif((Educ3.END_DATE is null),'#39#39','#39', '#39'+convert(varchar, Educ3.EN' +
        'D_DATE,104))'
      ' +iif((Educ3.KVAL is null)    ,'#39#39','#39', '#39'+Educ3.KVAL)'
      ' +iif((Educ3.NAPR is null)    ,'#39#39','#39', '#39'+Educ3.NAPR) as Educ3,'
      ''
      ' iif((P.PROF1 is null)       ,'#39#39','#39', '#39'+P.PROF1) as Prof1,'
      ...
      'left outer join KFSTATE KFST on (P.FST_ID=KFST.FST_ID))'
        ...
        'left outer join [Educ] as Educ3 on (P.PERS_ID=[Educ3].PERS_ID an' +
        'd [Educ3].type=3))'
      'left outer join [KUz] on [KUz].UZ_ID=[Educ].UZ_ID)'
      ...
      'WHERE P.OVK_ID=:OVK_ID'
      '  AND P.IS_WAR<>0'
      '  AND (P.W_DEND is  null or Year(P.W_DEND) >= Year(GetDate()))'
