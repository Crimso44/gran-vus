...
uses
  ...
  Db, dxUtils, dxTL, Vcl.Mask, dxTLStr, dxCntner, dxEditor, dxDBCtrl{$IFDEF DELPHI6},
  Variants{$ENDIF};
      ...
      try
        ...
        try
          ...
          begin
            ...
            System.Move(Pointer(FLoadedNodes.List)^, Pointer(FNodes.List)^, FLoadedNodes.Count * SizeOf(Pointer));
          end;
          if IsLoadAllRecords then
          begin
            // Load From DataSet
