...
{$IFDEF DELPHI12}
  DBPlatform,
{$ENDIF}
  DB, SqlTimSt, Classes, SysUtils, dxCore7;
...
var
  ...
  AC8691DB39266188AA2B5E454007AF62B: TSQLTimeStamp;
begin
  case AField.DataType of
    ftString, ftGuid:
    ...
    ftTimeStamp:
    begin
      AC8691DB39266188AA2B5E454007AF62B := GetTimeStampValue(ABuffer, AField);
      Result := VarSQLTimeStampCreate(AC8691DB39266188AA2B5E454007AF62B);
    end;
    ftBCD:
    begin
