...
{$I cxVer.inc}
{$MINENUMSIZE 1} //#AI: for correct TdxSkinElementStates restoring
...
{$ENDIF}
  ...
  dxOffice11, dxCore7, cxLookAndFeelPainters;
...
type
  ...
  protected
    ...
    procedure ReadTextureData(AStream: TStream);
    procedure WriteData(AStream: TStream);
    procedure WriteTextureData(AStream: TStream);
...
begin
  ...
  ReadTextureData(AStream);
  IsDirty := True;
end;

procedure TdxSkinImage.ReadTextureData(AStream: TStream);
var
...
begin
  ...
  begin
    ...
    try
      ...
      try
        Texture.LoadFromStream(APartStream);
      finally
        APartStream.Free;
      end;
    finally
...
begin
  ...
  WriteTextureData(AStream);
end;

procedure TdxSkinImage.WriteTextureData(AStream: TStream);
var
