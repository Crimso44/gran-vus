...
uses
  SysUtils, Messages, Windows, Classes, Vcl.Graphics, Vcl.Menus, Vcl.Controls, Vcl.Forms, Vcl.StdCtrls,
  dxCntner, dxEditor, dxExEdtr, DB{$IFNDEF DELPHI3}, DBTables {$ENDIF}, Vcl.DBCtrls,
...
uses
  Vcl.Consts, Vcl.Clipbrd, dxEdStr, Vcl.ExtDlgs, DBConsts{$IFDEF DELPHI6}, Vcl.VDBConsts{$ENDIF};
