exec sp_dboption N'GranVUS2', N'autoclose', N'false'
GO

exec sp_dboption N'GranVUS2', N'bulkcopy', N'true'
GO

exec sp_dboption N'GranVUS2', N'trunc. log', N'true'
GO

exec sp_dboption N'GranVUS2', N'torn page detection', N'true'
GO

exec sp_dboption N'GranVUS2', N'read only', N'false'
GO

exec sp_dboption N'GranVUS2', N'dbo use', N'false'
GO

exec sp_dboption N'GranVUS2', N'single', N'false'
GO

exec sp_dboption N'GranVUS2', N'autoshrink', N'false'
GO

exec sp_dboption N'GranVUS2', N'ANSI null default', N'false'
GO

exec sp_dboption N'GranVUS2', N'recursive triggers', N'false'
GO

exec sp_dboption N'GranVUS2', N'ANSI nulls', N'false'
GO

exec sp_dboption N'GranVUS2', N'concat null yields null', N'false'
GO

exec sp_dboption N'GranVUS2', N'cursor close on commit', N'false'
GO

exec sp_dboption N'GranVUS2', N'default to local cursor', N'false'
GO

exec sp_dboption N'GranVUS2', N'quoted identifier', N'false'
GO

exec sp_dboption N'GranVUS2', N'ANSI warnings', N'false'
GO

exec sp_dboption N'GranVUS2', N'auto create statistics', N'true'
GO

exec sp_dboption N'GranVUS2', N'auto update statistics', N'true'
GO

if( ( (@@microsoftversion / power(2, 24) = 8) and (@@microsoftversion & 0xffff >= 724) ) or ( (@@microsoftversion / power(2, 24) = 7) and (@@microsoftversion & 0xffff >= 1082) ) )
        exec sp_dboption N'GranVUS2', N'db chaining', N'false'
GO
...
ALTER TABLE [dbo].[ORG] ADD
        CONSTRAINT [IX_ORG_5] UNIQUE  NONCLUSTERED
        (
                [TERR_ID],
                [EXT_ID]
        )  ON [PRIMARY]
...
BEGIN TRANSACTION
        ...
        if @@ERROR != 0
        begin
                raiserror 51200 'Невозможно сделать территориальный орган текущим.'
                ROLLBACK TRANSACTION
                return
        end
        ...
        if @@ERROR != 0
        begin
                raiserror 51201 'Невозможно сделать территориальный орган текущим.'
                ROLLBACK TRANSACTION
                return
        end
        UPDATE SUBJ
        ...
        if @@ERROR != 0
        begin
                raiserror 51202 'Невозможно сделать территориальный орган текущим.'
                ROLLBACK TRANSACTION
                return
        end
COMMIT TRANSACTION
...
BEGIN TRANSACTION
        ...
        if @@ERROR != 0
        begin
                raiserror 50000 'Невозможно удалить форму № 6.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM FORM6HDR
        ...
        if @@ERROR != 0
        begin
                raiserror 50001 'Невозможно удалить форму № 6.'
                ROLLBACK TRANSACTION
                return
        end
COMMIT TRANSACTION
...
BEGIN TRANSACTION
        ...
        if @@ERROR != 0
        begin
                raiserror 50400 'Невозможно очистить формы № 6.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM FORM6HDR
        ...
        if @@ERROR != 0
        begin
                raiserror 50401 'Невозможно очистить формы № 6.'
                ROLLBACK TRANSACTION
                return
        end
COMMIT TRANSACTION
...
BEGIN TRANSACTION
        ...
        if @@ERROR != 0
        begin
                raiserror 50600 'Невозможно сформировать форму № 6.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM FORM6HDR
        ...
        if @@ERROR != 0
        begin
                raiserror 50601 'Невозможно сформировать форму № 6.'
                ROLLBACK TRANSACTION
                return
        end
        ...
        if @@ERROR != 0
        begin
                raiserror 50602 'Невозможно сформировать форму № 6.'
                ROLLBACK TRANSACTION
                return
        end
...
BEGIN TRANSACTION
        ...
        if @@ERROR != 0
        begin
                raiserror 51000 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM FORM6HDR
        ...
        if @@ERROR != 0
        begin
                raiserror 51001 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM ORG_CONT
        ...
        if @@ERROR != 0
        begin
                raiserror 51002 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM OSN
        ...
        if @@ERROR != 0
        begin
                raiserror 51003 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM PER
        ...
        if @@ERROR != 0
        begin
                raiserror 51004 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM ORG_PAYM
        ...
        if @@ERROR != 0
        begin
                raiserror 51005 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM ORGSET
        ...
        if @@ERROR != 0
        begin
                raiserror 51006 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
        DELETE FROM ORG
        ...
        if @@ERROR != 0
        begin
                raiserror 51007 'Невозможно удалить карточку организации.'
                ROLLBACK TRANSACTION
                return
        end
COMMIT TRANSACTION
